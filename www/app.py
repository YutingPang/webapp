...
async def init(loop):
    ...
    add_static(app)
    srv = await loop.create_server(app.make_handler(), '10.0.2.15', 9000)
    logging.info('server started at http://10.0.2.15:9000...')
